...
import (
	...
	"shop/inventory_srv/utils/register/consul"
	"syscall"
...
func main() {
	...
	c.Register(global.ServerConfig.Host, global.ServerConfig.Port, global.ServerConfig.Name, []string{"inventory-srv"}, serviceId)

...
const file_inventory_proto_rawDesc = "" +
	"\n" +
	"\x0finventory.proto\x1a\x1bgoogle/protobuf/empty.proto\"9\n" +
	"\vGoodInvInfo\x12\x16\n" +
	"\x06goodId\x18\x01 \x01(\x05R\x06goodId\x12\x12\n" +
	"\x04nums\x18\x02 \x01(\x05R\x04nums\"6\n" +
	"\bSellInfo\x12*\n" +
	"\tgoodInfos\x18\x01 \x03(\v2\f.GoodInvInfoR\tgoodInfos2\xbc\x01\n" +
	"\tInventory\x12.\n" +
	"\x06SetInv\x12\f.GoodInvInfo\x1a\x16.google.protobuf.Empty\x12'\n" +
	"\tInvDetail\x12\f.GoodInvInfo\x1a\f.GoodInvInfo\x12)\n" +
...
var file_inventory_proto_depIdxs = []int32{
	0, // 0: SellInfo.goodInfos:type_name -> GoodInvInfo

...
const file_good_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"good.proto\x1a\x1bgoogle/protobuf/empty.proto\";\n" +
	...
	"\x05total\x18\x01 \x01(\x05R\x05total\x12%\n" +
	"\x04data\x18\x02 \x03(\v2\x11.GoodInfoResponseR\x04data2\x9f\v\n" +
	"\x04Good\x121\n" +
	...
	"\n" +
	"CreateGood\x12\x0f.CreateGoodInfo\x1a\x11.GoodInfoResponse\x125\n" +
	"\n" +
	"DeleteGood\x12\x0f.DeleteGoodInfo\x1a\x16.google.protobuf.Empty\x125\n" +
	"\n" +
	"UpdateGood\x12\x0f.CreateGoodInfo\x1a\x16.google.protobuf.Empty\x124\n" +
	"\rGetGoodDetail\x12\x10.GoodInfoRequest\x1a\x11.GoodInfoResponse\x12D\n" +
...
var file_good_proto_goTypes = []any{
	...
	(*BatchGoodIdInfo)(nil),            // 19: BatchGoodIdInfo
	(*DeleteGoodInfo)(nil),             // 20: DeleteGoodInfo
	...
	(*CreateGoodInfo)(nil),             // 24: CreateGoodInfo
	(*GoodReduceRequest)(nil),          // 25: GoodReduceRequest
	(*BatchCategoryInfoRequest)(nil),   // 26: BatchCategoryInfoRequest
	(*GoodFilterRequest)(nil),          // 27: GoodFilterRequest
	(*GoodInfoResponse)(nil),           // 28: GoodInfoResponse
	(*GoodListResponse)(nil),           // 29: GoodListResponse
...
var file_good_proto_depIdxs = []int32{
	...
	21, // 8: GoodInfoResponse.category:type_name -> CategoryBriefInfoResponse
	15, // 9: GoodInfoResponse.brand:type_name -> BrandInfoResponse
	28, // 10: GoodListResponse.data:type_name -> GoodInfoResponse
	27, // 11: Good.GoodList:input_type -> GoodFilterRequest
	19, // 12: Good.BatchGetGood:input_type -> BatchGoodIdInfo
	24, // 13: Good.CreateGood:input_type -> CreateGoodInfo
	20, // 14: Good.DeleteGood:input_type -> DeleteGoodInfo
	24, // 15: Good.UpdateGood:input_type -> CreateGoodInfo
	23, // 16: Good.GetGoodDetail:input_type -> GoodInfoRequest
	30, // 17: Good.GetAllCategorysList:input_type -> google.protobuf.Empty
	0,  // 18: Good.GetSubCategory:input_type -> CategoryListRequest
	1,  // 19: Good.CreateCategory:input_type -> CategoryInfoRequest
	2,  // 20: Good.DeleteCategory:input_type -> DeleteCategoryRequest
	1,  // 21: Good.UpdateCategory:input_type -> CategoryInfoRequest
	13, // 22: Good.BrandList:input_type -> BrandFilterRequest
	14, // 23: Good.CreateBrand:input_type -> BrandRequest
	14, // 24: Good.DeleteBrand:input_type -> BrandRequest
	14, // 25: Good.UpdateBrand:input_type -> BrandRequest
	30, // 26: Good.BannerList:input_type -> google.protobuf.Empty
	11, // 27: Good.CreateBanner:input_type -> BannerRequest
	11, // 28: Good.DeleteBanner:input_type -> BannerRequest
	11, // 29: Good.UpdateBanner:input_type -> BannerRequest
	7,  // 30: Good.CategoryBrandList:input_type -> CategoryBrandFilterRequest
	1,  // 31: Good.GetCategoryBrandList:input_type -> CategoryInfoRequest
	9,  // 32: Good.CreateCategoryBrand:input_type -> CategoryBrandRequest
	9,  // 33: Good.DeleteCategoryBrand:input_type -> CategoryBrandRequest
	9,  // 34: Good.UpdateCategoryBrand:input_type -> CategoryBrandRequest
	29, // 35: Good.GoodList:output_type -> GoodListResponse
	29, // 36: Good.BatchGetGood:output_type -> GoodListResponse
	28, // 37: Good.CreateGood:output_type -> GoodInfoResponse
	30, // 38: Good.DeleteGood:output_type -> google.protobuf.Empty
	30, // 39: Good.UpdateGood:output_type -> google.protobuf.Empty
	28, // 40: Good.GetGoodDetail:output_type -> GoodInfoResponse
	5,  // 41: Good.GetAllCategorysList:output_type -> CategoryListResponse
	6,  // 42: Good.GetSubCategory:output_type -> SubCategoryListResponse
	4,  // 43: Good.CreateCategory:output_type -> CategoryInfoResponse
	30, // 44: Good.DeleteCategory:output_type -> google.protobuf.Empty
	30, // 45: Good.UpdateCategory:output_type -> google.protobuf.Empty
	16, // 46: Good.BrandList:output_type -> BrandListResponse
	15, // 47: Good.CreateBrand:output_type -> BrandInfoResponse
	30, // 48: Good.DeleteBrand:output_type -> google.protobuf.Empty
	30, // 49: Good.UpdateBrand:output_type -> google.protobuf.Empty
	17, // 50: Good.BannerList:output_type -> BannerListResponse
	12, // 51: Good.CreateBanner:output_type -> BannerResponse
	30, // 52: Good.DeleteBanner:output_type -> google.protobuf.Empty
	30, // 53: Good.UpdateBanner:output_type -> google.protobuf.Empty
	18, // 54: Good.CategoryBrandList:output_type -> CategoryBrandListResponse
	16, // 55: Good.GetCategoryBrandList:output_type -> BrandListResponse
	10, // 56: Good.CreateCategoryBrand:output_type -> CategoryBrandResponse
	30, // 57: Good.DeleteCategoryBrand:output_type -> google.protobuf.Empty
	30, // 58: Good.UpdateCategoryBrand:output_type -> google.protobuf.Empty

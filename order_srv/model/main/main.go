...
func main() {
	...
	// )
	dsn := "root:root123456@tcp(127.0.0.1:3306)/shop_order_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	_ = global.DB.AutoMigrate(&model.ShoppingCart{}, &model.OrderInfo{}, &model.OrderGood{})

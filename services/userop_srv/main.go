...
import (
	...
	"shop/pkg/port"
	"shop/pkg/proto"
	"shop/services/userop_srv/config"
	"shop/services/userop_srv/registry"
...
// migrateModels 随服务启动自动迁移的表。
var migrateModels = []any{
	&UserFav{}, &Address{}, &Message{},
}
...
func main() {
	...
	proto.RegisterUserOpServer(server, NewUserOpServer(db, log))
...
// openDB 连接到 MySQL，确保业务库存在后自动迁移 userop 服务所需的表。
...
// zapWriter 适配 zap.SugaredLogger 到 gorm logger.Writer。

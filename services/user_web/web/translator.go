...
// concurrently by request handlers. It cannot be injected per-request
// because gin handlers are plain functions, so it is a deliberately
// bounded, set-once package variable.

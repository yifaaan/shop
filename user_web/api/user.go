...
func GetUserList(ctx *gin.Context) {
	...
	// 调用用户服务
	resp, err := global.UserSrvClient.GetUserList(ctx.Request.Context(), &proto.PageInfoRequest{
...
func LoginPassword(ctx *gin.Context) {
	...
	// login逻辑
	// 获取user
	if u, err := global.UserSrvClient.GetUserByMobile(ctx.Request.Context(), &proto.MobileRequest{
		...
		// 检查密码
		ok, err := global.UserSrvClient.CheckPassword(ctx.Request.Context(), &proto.CheckPasswordInfoRequest{
...
func Register(ctx *gin.Context) {
	...
	// 调用用户服务创建用户
	u, err := global.UserSrvClient.CreateUser(ctx.Request.Context(), &proto.CreateUserInfoRequest{
